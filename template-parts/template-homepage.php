...
?>
		...
		<div class="container-fluid">
			<div class="row fullscreen d-flex align-items-center justify-content-between">
				<div class="col-lg-6 col-md-6 banner-img">
					<img class="img-fluid" src="<?php bloginfo('template_url'); ?> /img/banner-img.png ?>" alt="">
				</div>
		...
		<div class="container">
			...
			<div class="row justify-content-between align-items-center">
				...
				<div class="col-lg-6 about-left">
					<img class="img-fluid" src="<?php bloginfo('template_url'); ?> /img/about-img.png" alt="">
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			...
			<div class="row justify-content-center d-flex align-items-center">
				<div class="col-lg-6 col-md-6 single-feature">
					<figure>
						<img class="img-fluid" src="<?php bloginfo('template_url'); ?> /img/featured-class/f1.jpg" alt="">
						<div class="overlay overlay-bg"></div>
					</figure>
				...
				<div class="col-lg-6 col-md-6 single-feature">
					<figure>
						<img class="img-fluid" src="<?php bloginfo('template_url'); ?> /img/featured-class/f2.jpg" alt="">
						<div class="overlay overlay-bg"></div>
					</figure>
					<div class="text-center">
						<h4 class="mb-10">Get into shape now</h4>
				...
				<div class="col-lg-6 col-md-6 single-feature">
					<figure>
						<img class="img-fluid" src="<?php bloginfo('template_url'); ?> /img/featured-class/f3.jpg" alt="">
						<div class="overlay overlay-bg"></div>
					</figure>
					<div class="text-center">
						<h4 class="mb-10">Get into shape now</h4>
				...
				<div class="col-lg-6 col-md-6 single-feature">
					<figure>
						<img class="img-fluid" src="<?php bloginfo('template_url'); ?> /img/featured-class/f4.jpg" alt="">
						<div class="overlay overlay-bg"></div>
					</figure>
					<div class="text-center">
						<h4 class="mb-10">Get into shape now</h4>
	...
	<section class="schedule-area section-gap">
		<img class="featured-img img-fluid" src="<?php bloginfo('template_url'); ?> /img/featured-class/feature-img.png" alt="">
		<div class="container">
			<div class="row d-flex justify-content-center">
				<div class="col-lg-12">
					<div class="section-title-wrap text-center">
			...
			<div class="row">
				<div class="active-testimonial-carusel">
					<div class="single-testimonial item">
						<img class="mx-auto rounded-circle" src="<?php bloginfo('template_url'); ?> /img/t1.png" alt="">
						<p class="desc">
					...
					<div class="single-testimonial item">
						<img class="mx-auto rounded-circle" src="<?php bloginfo('template_url'); ?> /img/t2.png" alt="">
						<p class="desc">
					...
					<div class="single-testimonial item">
						<img class="mx-auto rounded-circle" src="<?php bloginfo('template_url'); ?> /img/t3.png" alt="">
						<p class="desc">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 col-sm-12 single-blog">
					<div class="thumb">
						<img class="img-fluid" src="<?php bloginfo('template_url'); ?> /img/b1.jpg" alt="">
					</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-12 single-blog">
					<div class="thumb">
						<img class="img-fluid" src="<?php bloginfo('template_url'); ?> /img/b2.jpg" alt="">
					</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-12 single-blog">
					<div class="thumb">
						<img class="img-fluid" src="<?php bloginfo('template_url'); ?> /img/b3.jpg" alt="">
					</div>
					<a href="single-blog.html"><h4>Summer ware are coming</h4></a>
					<div class="text-wrap">
						<p>
